    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(blank=True, max_length=50, null=True, verbose_name='Cor')),
                ...
                ('vehicle_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='vehicles', to='vehicle.vehicletype', verbose_name='Tipo do veículo')),
            ],
            options={
